package com.sliora.boardserver.config;
...
public class RedisConfig {
    ...
    public ObjectMapper objectMapper() {
        ...
        mapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);     //타임스템프 설정하지 못하도록 방지
        mapper.registerModules(new JavaTimeModule(), new Jdk8Module());     //자바의 날짜값으로 인식하도록 설정
        return mapper;
    }
